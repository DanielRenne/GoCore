...
Schemas are to be defined within a directory beneath db/[Applicaiton Name]/schemas.  Any file with a .json extension will be processed to create a NOSQL model.  NOTE:  Additional sub directories are recursively walked and processed to support larger application organization.
