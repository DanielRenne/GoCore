## Basic Router engine usage with gin

After calling app.InitializeLite() or app.Initialize() (basically your first line of code in your main) you can access the gin.Engine object through ginServer.Router export and use it to add your own routes.
