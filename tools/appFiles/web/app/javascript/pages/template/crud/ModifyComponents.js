...
class -CAPCAMEL-Modify extends BasePageComponent {
  ...
  createComponentEvents() {
    ...
    this.save = () => {
      window.api.post({action: "Update-CAPCAMEL-Details", state: this.state, controller:"-CAMELPLURAL-"});
    };

    this.create-CAPCAMEL- = () => {
      window.api.post({action: "Create-CAPCAMEL-", state: this.state, controller:"-CAMELPLURAL-"});
    };
  }
...
export default BackPage(-CAPCAMEL-Modify);
